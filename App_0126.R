  ...
  fluidPage(theme = shinytheme("cyborg"),
            fluidRow(column(3,
                            wellPanel(h2("Control Panel"),
                                      ...
                                      hr(),
                                      h3("Data Viewer:"),
                                      selectInput("Alliance","Choose Alliance",c(Alliances,"All"),selected = "ApexPredators"),
                            ...
                            sidebarPanel(h3("Notes:"),br(),HTML("<ul><li><b>[Starting Date]:</b> Choose the first day of current round of poll to exclude old votes</li>
                                                                       ...
                                                                       <li><b>[Weight]:</b> 1st.Choices*4.1 (default) + 2ed.Choices*2.01 + 3rd.Choices*1 + </li>
                                                                       <li><b>[Lists Creating]:</b> rank dinos by weight, decide number of dinos not in the column 1st.Choices
                                                                       , every dino in column 1st.Choice will be at least singled and double to fill the rest of slots</li></ul>"),width=15)
            ),              
            column(9,
